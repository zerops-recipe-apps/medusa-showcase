...
Medusa v2.19 backend + Next.js 16 storefront monorepo on Zerops (`nodejs@24`). Canonical app repo for the [Medusa recipe](https://app.zerops.io/recipes/medusa).
...
Root [`zerops.yml`](zerops.yml) — both setups. Imports: [`.zerops-recipe/`](.zerops-recipe/) (mirrors `zeropsio/recipes/medusa`).
